...
public class Client {
    ...
    /**
     * Status of user (logged in status in network).
     */
    @Column(name = "status")
    @Basic
    private int status;
    ...
    /**
     * Enabled status (Website administrator can allow to log in, old user's login can denied.).
     */
